...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "sklearn.decomposition.cdnmf_fast"
}
END: Cython Metadata */
...
static const char __pyx_k_update_cdnmf_fast[] = "_update_cdnmf_fast";
...
static const char __pyx_k_workspace_sam_kupfer_Git_data_s[] = "/workspace/sam_kupfer/Git/data-science_spark_scoring_modified_tree/scikit-learn/sklearn/decomposition/cdnmf_fast.pyx";
...
static const char __pyx_k_sklearn_decomposition_cdnmf_fast[] = "sklearn.decomposition.cdnmf_fast";
...
static PyObject *__pyx_pw_7sklearn_13decomposition_10cdnmf_fast_1_update_cdnmf_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_update_cdnmf_fast (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_HHt)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_update_cdnmf_fast", 1, 4, 4, 1); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_XHt)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_update_cdnmf_fast", 1, 4, 4, 2); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_permutation)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_update_cdnmf_fast", 1, 4, 4, 3); __PYX_ERR(0, 12, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_update_cdnmf_fast") < 0)) __PYX_ERR(0, 12, __pyx_L3_error)
      }
    ...
    __pyx_v_W = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0]); if (unlikely(!__pyx_v_W.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_HHt = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_HHt.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_XHt = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2]); if (unlikely(!__pyx_v_XHt.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_permutation = __Pyx_PyObject_to_MemoryviewSlice_dc_Py_ssize_t(values[3]); if (unlikely(!__pyx_v_permutation.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_update_cdnmf_fast", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 12, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  ...
  __pyx_t_27 = PyFloat_FromDouble(__pyx_v_violation); if (unlikely(!__pyx_t_27)) __PYX_ERR(0, 41, __pyx_L1_error)
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "sklearn.decomposition.cdnmf_fast")) {
      if (unlikely(PyDict_SetItemString(modules, "sklearn.decomposition.cdnmf_fast", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef double violation = 0
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7sklearn_13decomposition_10cdnmf_fast_1_update_cdnmf_fast, NULL, __pyx_n_s_sklearn_decomposition_cdnmf_fast); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_update_cdnmf_fast, __pyx_t_1) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
